...
local function lsp_keymaps(bufnr)
	...
	keymap(bufnr, "n", "lK", "<cmd>lua vim.lsp.buf.hover()<CR>", opts)
	keymap(bufnr, "n", "lI", "<cmd>lua vim.lsp.buf.implementation()<CR>", opts)
	keymap(bufnr, "n", "lR", "<cmd>lua vim.lsp.buf.references()<CR>", opts)
